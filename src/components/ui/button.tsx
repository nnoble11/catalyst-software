...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center rounded-md border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive/50 aria-invalid:ring-3 aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default: "bg-primary/90 border-primary/20 text-primary-foreground hover:bg-primary/80 hover:shadow-[0_0_15px_oklch(0.65_0.2_45/10%)]",
        outline:
          "border-input bg-input/20 hover:bg-input/40 hover:text-foreground hover:shadow-[0_0_15px_oklch(0.65_0.2_45/8%)] aria-expanded:bg-input/50 aria-expanded:text-foreground",
        secondary:
